...
const MONGODB_URI =
  "mongodb+srv://mananjay82:3YyTwhcPhOWTPG4I@cluster0.elcge.mongodb.net/myshop?authSource=admin&replicaSet=atlas-630pak-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass&retryWrites=true&ssl=true";
...
app.use((req, res, next) => {
  ...
  User.findById(req.session.adminuser._id)
    .then((user) => {
      req.adminuser = user;
      next();
    })
